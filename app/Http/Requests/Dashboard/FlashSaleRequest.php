    ...
    public function messages(): array
    {
        if (app()->getLocale() == 'ar') {
            return [
                ...
                'time.integer' => 'الوقت يجب أن يكون عددًا صحيحًا.',
                'time.min' => 'الوقت يجب أن يكون على الأقل دقيقة واحدة.',
                'time.max' => 'الوقت يجب أن لا يتجاوز 1440 دقيقة.',
            ...
            return [
                ...
                'time.min' => 'The time must be at least one minute.',
                'time.max' => 'The time must not exceed 1440 minutes.',
