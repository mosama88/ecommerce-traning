...
class OrderController extends Controller
{
    ...
    {
        $data = Order::filter(request()->all())->orderBy('id', 'DESC')->paginate();
        $getData['shipping_areas'] = ShippingArea::get();
        $getData['users']  = User::get();
        return view('dashboard.orders.index', compact('data', 'getData'));
    }
    ...
    function create()
    {
        $getData['shipping_areas'] = ShippingArea::get();
        $getData['users']  = User::get();
        return view('dashboard.orders.create', compact('getData'));
    }
    ...
    function show($id)
    {
        ...
        $getData['shipping_areas'] = ShippingArea::get();
        $getData['users']  = User::get();
        return view('dashboard.orders.show', compact('order', 'getData'));
    }
    ...
    function edit(Order $order)
    {
        $getData['shipping_areas'] = ShippingArea::get();
        $getData['users']  = User::get();
        return view('dashboard.orders.edit', compact('order', 'getData'));
    }
    ...
    public function update(OrderRequest $request, Order $order)
    {
        ...
        return redirect()->route('dashboard.orders.index')->with('success', 'Order Has Been Updeted');
    }
