  <div class="card-header">
      <div>
          <x-adminlte-input name="name_search" fgroup-class="col-md-3" value="{{ request('name_search') }}" type="text"
              label="{{ __('category.category_name') }}" placeholder="ex:Category Name...." />

          <div class="form-check mx-2">
              <input class="form-check-input" name="discount_search" type="checkbox" value="" id="flexCheckChecked">
